...
export const STATIC_I18N_KEYS = [
  ...
  'View and update global system configuration.',
  'Back to Dashboard',
  'Auto-disable rules',
  ...
  'View channel routing health, decisions, costs, policies, and operations.',
  'Operate channel routing',
  'Run probes, synchronize costs, and reset runtime routing state.',
  'Edit channel routing policies',
  'Create, edit, validate, and simulate channel routing policy drafts.',
  'Deploy channel routing policies',
  'Approve, publish, promote, and roll back channel routing policies.',
  'Edit sensitive channel routing settings',
  'Edit upstream credentials, private egress rules, and other sensitive routing settings.',
  'Export channel routing audits',
  'Export bounded channel routing decision and policy audit data.',
  'Routing groups',
  'Channel health',
  'Decision audit',
  'Upstream costs',
  ...
  'Cache read / million',
  'Cache write / million',
  '1h cache write / million',
  'Image input / million',
  'Image output / million',
  'Image cost',
  'Per image',
  'Audio input / million',
  'Audio output / million',
  'Per request',
  'Base ratio',
  'Completion ratio',
  'Routing policies',
  ...
  // Channel routing cost catalog and comparison (dynamic labels / validation)
  'Dimensions',
  'Request fields',
  'Request profile',
  'Request pricing features',
  'Uncatalogued surcharge',
  'Enter zero or a positive finite quantity',
  'Select a routing pool',
  'Enter 256 characters or fewer',
  'Enter 64 characters or fewer',
  'Enter a whole number from 1 to 16',
  'Enter a value from 0 to 1',
  'Enter a model name',
  'Enter a recent decision ID',

  // Channel routing runtime settings (labels passed to t() dynamically)
  'Request profiling',
  'Routing mode',
  'Candidate count',
  'Consecutive 5xx threshold',
  'Failure rate threshold',
  'Base cooldown',
  'Maximum cooldown',
  'Maximum ejected capacity',
  'Half-open probes',
  'Maximum route switches',
  'Retry token capacity',
  'Retry token refill rate',
  'Failover deadline',
  ...
  'Hedge requests',
  'Maximum concurrent hedges',
  'Maximum hedged response size',
  'Maximum hedge buffer',
  'Hedge ratio window',
  'Maximum extra hedge ratio',
  'Hedge audit retention',
  'Live snapshot window',
  'Stale snapshot window',
  'Balance safety margin',
  'Configuration sync interval',
  'Hot-cache refresh interval',
  'Metric bucket size',
  ...
  'Open-state probe interval',
  'Probe timeout',
  'Maximum probe targets',
  'Probe concurrency',
  'Per-host probe concurrency',
  'Probe token budget',
  'Probe cost budget',
  'Observe only',
  'Shadow routing',
  'Balanced routing',
  'Basics and operating mode',
  'Choose whether the routing runtime participates in requests and how aggressively it may influence selection.',
  'Scoring and candidates',
  'Control candidate breadth, evidence requirements, and how the runtime balances availability, latency, throughput, and cost.',
  'Circuit breaking and recovery',
  'Define when unhealthy capacity is ejected, how much capacity may be removed, and how recovery probes are admitted.',
  'Retries and failover',
  'Bound route switching, retry budgets, cost amplification, deadlines, and status-specific backoff behavior.',
  'First-byte switching',
  'Switch away from a slow upstream before response bytes are committed, using bounded latency thresholds.',
  'Bound speculative duplicate requests, response buffering, additional traffic, and audit retention.',
  'Schedule bounded health probes with separate healthy, degraded, and open-state cadence plus explicit cost controls.',
  'Refresh and retention',
  'Control snapshot freshness, balance reserve, cache refresh, metric aggregation, persistence, and retention windows.',
  ...
  'Enter a value at or above the allowed minimum',
  'Enter a value from 0 to 1',
  ...
  // Channel routing policy visual editor (labels passed to t() dynamically)
  'Requests per minute',
  'Input tokens per minute',
  'Output tokens per minute',
  'Total tokens per minute',
  'Inflight limit',
  'Cost limit in nanoUSD',
