...
export const STATIC_I18N_KEYS = [
  ...
  // Payment order/provider labels (passed to t at runtime)
  'Success',
  'Pending',
  'Processing',
  'Failed',
  ...
  'Configure payment gateway credentials, callbacks, and payment availability.',
  'Manage payment operations',
  'Review payment exceptions and apply audited financial resolutions.',
  'Epay',
  'Stripe',
  'Alipay',
  'WeChat Pay',
