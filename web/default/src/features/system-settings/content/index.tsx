...
const defaultContentSettings: ContentSettings = {
  ...
  'console_setting.api_info_test_latency_enabled': true,
  'console_setting.api_info_external_speed_test_enabled': true,
  'console_setting.api_info_open_new_tab_enabled': true,
