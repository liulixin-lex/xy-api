...
describe('classic emergency credential replacement', () => {
  test('sends a replacement whsec atomically when entered', () => {
    assert.deepEqual(
  ...
  test('leaves options empty so the backend disables webhooks without a replacement', () => {
    assert.deepEqual(
