...
func TestChannelRoutingRoutesUseExplicitPermissions(t *testing.T) {
	expected := map[string]permissionRoute{
		...
		"/cost-catalog/pools":                  {method: http.MethodGet, permission: authz.ChannelRoutingRead},
		"/cost-catalog/pools/:pool_id/members": {method: http.MethodGet, permission: authz.ChannelRoutingRead},
		"/cost-catalog/pools/:pool_id/members/:member_id/models": {method: http.MethodGet, permission: authz.ChannelRoutingRead},
		"/cost-catalog/pools/:pool_id/members/:member_id/model":  {method: http.MethodGet, permission: authz.ChannelRoutingRead},
	...
	writeExpected := map[string]authz.Permission{
		...
		http.MethodPost + " /cost-estimates":                       authz.ChannelRoutingRead,
		...
		http.MethodGet + " /control-audits/:id/technical":          authz.ChannelRoutingAuditExport,
		http.MethodGet + " /operations/:id/technical":              authz.ChannelRoutingAuditExport,
		http.MethodPost + " /policy-drafts":                        authz.ChannelRoutingWrite,
		http.MethodDelete + " /policy-drafts":                      authz.ChannelRoutingWrite,
		http.MethodPut + " /policy-drafts/:id":                     authz.ChannelRoutingWrite,
		http.MethodDelete + " /policy-drafts/:id":                  authz.ChannelRoutingWrite,
		...
		http.MethodPost + " /policies/:version/rollback-draft":     authz.ChannelRoutingWrite,
		http.MethodPost + " /operations/:id/retry":                 authz.ChannelRoutingOperate,
		http.MethodPost + " /operations/:id/cancel":                authz.ChannelRoutingOperate,
	}
