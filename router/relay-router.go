...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.DistributeDeferred())
	{
	...
	relayV1Router.Use(middleware.ModelRequestRateLimit())
	{
		...
		wsRouter.Use(middleware.DistributeDeferred())
	...
	}
	{
		...
		httpRouter.Use(middleware.DistributeDeferred())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), middleware.DistributeDeferred())
	{
	...
	relayGeminiRouter.Use(middleware.DistributeDeferred())
	{
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	mediaRouter := relayMjRouter.Group("")
	mediaRouter.Use(middleware.TokenOrUserAuth())
	{
		mediaRouter.GET("/image/:id", relay.RelayMidjourneyImage)
		mediaRouter.GET("/video/:id", relay.RelayMidjourneyVideo)
		mediaRouter.GET("/video/:id/:index", relay.RelayMidjourneyVideo)
	}
	relayMjRouter.Use(middleware.TokenAuth(), middleware.DistributeDeferred())
	{
