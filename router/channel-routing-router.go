...
var channelRoutingReadRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/runtime-settings", permission: authz.ChannelRoutingRead, handler: controller.GetChannelRoutingRuntimeSettings},
	{method: http.MethodGet, path: "/control-audits", permission: authz.ChannelRoutingRead, handler: controller.ListChannelRoutingControlAudits},
	...
	{method: http.MethodGet, path: "/cost-catalog/pools", permission: authz.ChannelRoutingRead, handler: controller.ListChannelRoutingCostCatalogPools},
	{method: http.MethodGet, path: "/cost-catalog/pools/:pool_id/members", permission: authz.ChannelRoutingRead, handler: controller.ListChannelRoutingCostCatalogMembers},
	{method: http.MethodGet, path: "/cost-catalog/pools/:pool_id/members/:member_id/models", permission: authz.ChannelRoutingRead, handler: controller.ListChannelRoutingCostCatalogModels},
	{method: http.MethodGet, path: "/cost-catalog/pools/:pool_id/members/:member_id/model", permission: authz.ChannelRoutingRead, handler: controller.GetChannelRoutingCost},
	...
	{method: http.MethodGet, path: "/policy-drafts/:id/approvals", permission: authz.ChannelRoutingRead, handler: controller.ChannelRoutingPolicyApprovalRetired},
	...
	{method: http.MethodGet, path: "/policies/:version/rollback-approvals", permission: authz.ChannelRoutingRead, handler: controller.ChannelRoutingPolicyApprovalRetired},
...
var channelRoutingWriteRoutes = []permissionRoute{
	...
	{method: http.MethodPost, path: "/cost-estimates", permission: authz.ChannelRoutingRead, handler: controller.EstimateChannelRoutingCosts},
	...
	{method: http.MethodGet, path: "/control-audits/:id/technical", permission: authz.ChannelRoutingAuditExport, handler: controller.GetChannelRoutingControlAuditTechnical},
	{method: http.MethodGet, path: "/operations/:id/technical", permission: authz.ChannelRoutingAuditExport, handler: controller.GetChannelRoutingOperationTechnical},
	...
	{method: http.MethodDelete, path: "/policy-drafts", permission: authz.ChannelRoutingWrite, handler: controller.DeleteChannelRoutingPolicyDrafts},
	...
	{method: http.MethodDelete, path: "/policy-drafts/:id", permission: authz.ChannelRoutingWrite, handler: controller.DeleteChannelRoutingPolicyDraft},
	...
	{method: http.MethodPost, path: "/policy-drafts/:id/approvals", permission: authz.ChannelRoutingDeploy, handler: controller.ChannelRoutingPolicyApprovalRetired},
	...
	{method: http.MethodPost, path: "/policies/:version/rollback-approvals", permission: authz.ChannelRoutingDeploy, handler: controller.ChannelRoutingPolicyApprovalRetired},
	...
	{method: http.MethodPost, path: "/policies/:version/rollback-draft", permission: authz.ChannelRoutingWrite, handler: controller.CreateChannelRoutingPolicyRollbackDraft},
	{method: http.MethodPost, path: "/operations/:id/retry", permission: authz.ChannelRoutingOperate, handler: controller.RetryChannelRoutingOperation},
	{method: http.MethodPost, path: "/operations/:id/cancel", permission: authz.ChannelRoutingOperate, handler: controller.CancelChannelRoutingOperation},
}
