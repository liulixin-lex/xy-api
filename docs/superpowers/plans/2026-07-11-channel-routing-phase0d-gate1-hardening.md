...
- [ ] **GREEN 1：改为 ConfigManager Snapshot/Replace**
...
- [ ] **RED 1：写 Drain/Record/Delete 线性化测试**
...
- [ ] **GREEN 1：定义 Store、Limits 和 Stats**
...
- [ ] **GREEN 4：Query 改读 Store 快照，RuntimeStats 可观测**
...
- [ ] **RED 1：写无溢出 Capped Exponential Backoff 测试**
...
- [ ] **RED 2：写首次执行、错误退避、恢复和 Close/Wait 测试**
...
- [ ] **RED 3：写 Retention 0、正数清理、节流和溢出测试**
...
- [ ] **GREEN 2：增加 Context-aware Perf Model 方法**
...
- [ ] **GREEN 2：Bulk options 按命名空间一次发布**
...
- [ ] **RED 1：把 Runtime callback 改为 Context/error 契约测试**
...
- [ ] **RED 2：写 Refresh/Flush 独立错误统计与恢复测试**
...
- [ ] **GREEN 1：增加 Context-aware Model 入口**
...
- [ ] **GREEN 3：实现两个独立 worker 的 Backoff/Stats**
...
- [ ] **RED 2：写 TLS/Proxy/共享 Transport 测试**
...
- [ ] **RED 2：写 Content-Length 与 chunked limit+1 测试**
...
- [ ] **GREEN 2：所有 endpoint 先安全读取再 common.Unmarshal**
...
- [ ] **RED 2：写 LastSyncError/API/SystemTask 三出口测试**
...
- [ ] **RED 3：写持久化 failure count 驱动 Backoff 测试**
