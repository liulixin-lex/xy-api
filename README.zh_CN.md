...
> [!NOTE]
> `v0.2` 开发线基于本 Fork 的 `v0.1.6`，并以保持其生产兼容为前提；不会直接包含 `v0.1.7` 至 `v0.1.14` 的渠道路由系列改动。升级或移植代码前请先阅读 `COMPATIBILITY.md` 与 `UPSTREAM.md`。
...
### 📖 [官方文档](https://docs.newapi.pro/zh/docs) | [![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/liulixin-lex/xy-api)
...
**[官方文档](https://docs.newapi.pro/zh/docs)** • **[问题反馈](https://github.com/liulixin-lex/xy-api/issues)** • **[最新发布](https://github.com/liulixin-lex/xy-api/releases)**
