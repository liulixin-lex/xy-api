...
type ConsoleSetting struct {
	...
	ApiInfoTestLatencyEnabled       bool   `json:"api_info_test_latency_enabled"`        // 是否显示 API 地址测试延迟按钮
	ApiInfoExternalSpeedTestEnabled bool   `json:"api_info_external_speed_test_enabled"` // 是否显示 API 地址外部测速按钮
	ApiInfoOpenNewTabEnabled        bool   `json:"api_info_open_new_tab_enabled"`        // 是否显示 API 地址新标签页打开按钮
...
var defaultConsoleSetting = ConsoleSetting{
	...
	FAQ:                             "",
	ApiInfoEnabled:                  true,
	ApiInfoTestLatencyEnabled:       true,
	ApiInfoExternalSpeedTestEnabled: true,
	ApiInfoOpenNewTabEnabled:        true,
